...
// about tablosundan verileri çekin
$sql = "SELECT title, author, time, content FROM about";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // Verileri döngüyle alın ve HTML koduna yerleştirin
    while ($row = $result->fetch_assoc()) {
        ...
        // HTML kodunda verilerin yer aldığı yerleri düzenleyin
